...
export default async function FitnessClientMasterDetailCompatibilityPage({
  ...
  return (
    <ProtectedRoute>
      <AppShell title="Master Data Klien lama" subtitle="Compatibility route Admin Kelaikan" breadcrumbs={[{ label: "Admin Kelaikan", href: "/fitness/dashboard" }, { label: "Klien & Master Data", href: "/fitness/master-data/customers" }, { label: "Compatibility" }]}>
        <FitnessMasterCompatibilityNotice
          title="Master Data Klien lama"
