-- Additive Survey Sheet header snapshots and Surveyor-only cleanliness.
-- Source records remain authoritative; these columns preserve the transaction context at Survey start.
